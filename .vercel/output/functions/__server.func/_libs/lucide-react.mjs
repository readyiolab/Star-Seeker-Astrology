...
const Droplet = createLucideIcon("droplet", __iconNode$J);
const __iconNode$I = [
...
const FilePlay = createLucideIcon("file-play", __iconNode$E);
const __iconNode$D = [
  [
    "path",
    {
...
const __iconNode$n = [["path", { d: "m8 3 4 8 5-5 5 15H2L8 3z", key: "otkl63" }]];
const Mountain = createLucideIcon("mountain", __iconNode$n);
const __iconNode$m = [
...
const Orbit = createLucideIcon("orbit", __iconNode$m);
const __iconNode$l = [
