...
class RouteApi extends BaseRouteApi {
  ...
  constructor({ id }) {
    ...
    this.Link = React$1.forwardRef((props, ref) => {
      const router = useRouter();
      const fullPath = router.routesById[this.id].fullPath;
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { ref, from: fullPath, ...props });
    });
  }
}
