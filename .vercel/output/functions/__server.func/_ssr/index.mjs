...
import { a as rootRouteId, q as getNormalizedURL, u as getOrigin, v as attachRouterServerSsrUtils, w as defineHandlerCallback, x as createSerializationAdapter, y as createRawStreamRPCPlugin, i as isNotFound, b as isRedirect, z as isResolvedRedirect, A as mergeHeaders, C as executeRewriteInput, D as defaultSerovalPlugins, E as makeSerovalPlugin } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DOLyH24j.mjs");
...
async function loadEntries() {
  const routerEntry = await import("./router-Dmdsn4PS.mjs").then((n) => n.r);
